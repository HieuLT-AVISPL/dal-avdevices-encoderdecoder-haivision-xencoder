...
public class EncoderConstant {
	...
	public static final String MIN_BITRATE = "32";
	public static final String MAX_BITRATE = "25000";
	public static final String MIN_GOP_SIZE = "1";
	public static final String MAX_GOP_SIZE = "1000";
	public static final String MIN_REFRESH_RATE = "1";
	public static final String MAX_REFRESH_RATE = "5000";
	public static final String DEFAULT_REFRESH_RATE = "60";
